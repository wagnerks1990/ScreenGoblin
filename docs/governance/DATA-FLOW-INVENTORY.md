...
| Control-plane API  | Auth, publishing metadata, enrollment, heartbeat         | PostgreSQL records and audit events                                             | Database, Redis, object storage, signed manifests                 | P-256 proof, revocation, and staged targeted re-enrollment exist; upload security, scoped approval, attestation, automatic overlapping rotation, verified erasure, and complete transactional audit coverage remain gates |
