...
| Control-plane API  | Auth, publishing metadata, enrollment, heartbeat         | PostgreSQL records and audit events                                             | Database, Redis, private object storage, signed manifests         | P-256 proof, revocation, staged targeted initial enrollment/re-enrollment, and assignment-bound private media delivery exist; upload/quarantine/scanning, scoped approval, attestation, automatic overlapping rotation, verified erasure, and complete transactional audit coverage remain gates |
