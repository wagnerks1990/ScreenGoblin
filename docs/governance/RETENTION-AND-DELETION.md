...
| ---------------------------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- | --------------------------------------------------- |
| User account and membership        | While authorized; disable promptly, delete after approved offboarding interval | Revoke sessions, remove membership, preserve only required audit attribution | **Unapproved / incomplete**                         |
...
| Pairing codes                      | Expiry plus 24 hours for abuse investigation                                   | Delete HMAC-derived verifier and metadata                                    | **Unapproved / no verified cleanup**                |
...
| Published release metadata         | While assigned plus 365 days proposal                                          | Preserve release/audit integrity, then approved purge                        | **Target model not implemented**                    |
