...
| Publishing        | Accepted ordinary release candidates reaching terminal success/failure         | 99.5% within 5 minutes           | API lifecycle exists; production measurement/alerting, Console flow, and scoped grants remain incomplete. Emergency is excluded and disabled |
