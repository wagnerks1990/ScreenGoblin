...
| Publishing        | Accepted ordinary release candidates reaching terminal success/failure         | 99.5% within 5 minutes           | API and Console lifecycle exist; production measurement/alerting, rejection/rollback, and scoped grants remain incomplete. Emergency is excluded and disabled |
